    ...
    <div className="App">
      ...
      <form className="form-wrapper" onSubmit={handleSubmit} data-testid="form-wrapper">
        <div className="useremail-wrapper">
          ...
          <input type="email" value={state.email} onChange={(e)=> dispatch({type: "email", payload: e.target.value})} data-testid="user-email" />
        </div>
        <div className="userpassword-wrapper">
          <label>User Password</label>
          <input type="password" value={state.password} onChange={(e)=> dispatch({type:"password", payload: e.target.value})} data-testid="user-password" />
        </div>
